// ================================================================================================
// File: config/config_keys.h
// Purpose: Game-specific JSON keys for Atrapacielos configuration.
// Used by: ConfigLoader (player.json), ResourceRegistry (resources.json) and other Atrapacielos loaders
...
namespace game::atrapacielos::config::keys {

    // --------------------------------------------------------------------------------------------
    // Ключи для игрового конфига Atrapacielos (assets/config/atrapacielos.json)
    // --------------------------------------------------------------------------------------------
    namespace Game {
