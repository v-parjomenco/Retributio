// ================================================================================================
// File: game.h
// Role: High-level application for Atrapacielos (window, loop, ECS wiring)
// Notes:
//  - Lives in the game layer, depends on core engine only
//  - Owns TimeService and ECS World, wires Atrapacielos-specific systems
...
#include "orchestration/frame_orchestrator.h"
...
#include "presentation/window_mode_manager.h"
...
namespace game::atrapacielos {
    ...
    class Game {
      ...
      private:
        ...
        /// Создаёт ECS-мир и инициализирует сущности Atrapacielos.
        void initWorld();
      ...
      private:
        ...
        game::atrapacielos::ecs::AircraftControlSystem* mAircraftControlSystem{nullptr};
        game::atrapacielos::ecs::SpatialStreamingSystem* mSpatialStreamingSystem{nullptr};
