// ================================================================================================
// File: presentation/view_manager.h
// Purpose: Manage WorldView and UiView for Atrapacielos (letterbox + UI separation).
// Used by: game::atrapacielos::Game.
// Related headers: config/view_config.h, core/ui/viewport_utils.h
// Notes:
//  - Atrapacielos: canonical resize path = ViewManager only. Do NOT wire ScalingSystem/LockSystem here.
// ================================================================================================
#pragma once
...
namespace game::atrapacielos::presentation {
    ...
    /**
     * @brief Управляет WorldView и UiView для Atrapacielos.
     *
     * Ответственность:
