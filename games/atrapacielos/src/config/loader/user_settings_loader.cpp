...
namespace {
    ...
    static constexpr std::string_view kLoaderTag = "Atrapacielos::UserSettingsLoader";
    ...
    [[nodiscard]] std::string_view toModeString(game::atrapacielos::config::WindowMode mode) noexcept {
        using WM = game::atrapacielos::config::WindowMode;
        switch (mode) {
    ...
    [[nodiscard]] std::optional<game::atrapacielos::config::WindowMode> parseModeString(
