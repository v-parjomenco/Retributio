...
// Notes:
//  - Private to sfml1_sfml_audio target. Do not include from core or game code.
//  - This header lives in include_private/ and is reachable ONLY from sfml1_sfml_audio
