...
namespace core::utils::json {
    ...
    sf::Keyboard::Key parseKeyString(const std::string& name) {
        ...
        if (name == "LShift") return K::LShift;
        if (name == "RShift") return K::RShift;
        if (name == "LControl") return K::LControl;
        if (name == "RControl") return K::RControl;
        if (name == "LAlt") return K::LAlt;
        if (name == "RAlt") return K::RAlt;
