...
namespace core::resources::loader {
    ...
    std::unique_ptr<types::TextureResource> ResourceLoader::loadTexture(const std::string& path, bool smooth) {
    ...
    std::unique_ptr<types::SoundBufferResource> ResourceLoader::loadSoundBuffer(const std::string& path) {
