...
namespace game::skyguard::dev {
    ...
    StressChunkContentProvider::StressChunkContentProvider(
        ...
        const std::size_t enabledFlag =
            readEnvSize("SKYGUARD_STRESS_ENABLED", /*default*/ 0, /*max*/ 1);

        const std::size_t envEntities =
            readEnvSize("SKYGUARD_STRESS_ENTITIES_PER_CHUNK", /*default*/ 0, kMaxEntitiesPerChunk);
        ...
        const std::size_t seedValue =
            readEnvSize("SKYGUARD_STRESS_SEED", /*default*/ 1, /*max*/ 0xFFFFFFFFu);
