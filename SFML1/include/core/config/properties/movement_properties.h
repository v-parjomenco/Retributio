...
// Purpose: Data-only movement configuration brick (maxSpeed/accel/friction)
...
namespace core::config::properties {
     ...
     *  - значения по умолчанию здесь — лишь удобный fallback.
     * 
     * Конвенция:
     *  - поле maxSpeed по смыслу маппится на MovementStatsComponent::maxSpeed
     */
