...
// Used by: main_skyguard.cpp (game entry point requiring exclusive launch).
...
//   - Uses CreateMutexW with the name "Global\SkyGuard_Game_Mutex".
...
//   - Uses an exclusive flock on a file in the temp directory ("skyguard.lock").
