...
namespace core::ecs {
     ...
     *
     * Cистемы:
     *  - не хранят ECS-состояние игры (оно живёт в компонентах/сервисах);
     *    при этом системе разрешены внутренние scratch/caches (например, для render batching),
     *    если они не являются источником истины для gameplay.
