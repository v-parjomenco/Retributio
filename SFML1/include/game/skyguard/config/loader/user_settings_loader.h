// ================================================================================================
// File: game/skyguard/config/loader/user_settings_loader.h
// Purpose: User settings loader + atomic save (override shipped defaults).
// Used by: game::skyguard::Game (startup override + persistence on window changes).
// Related headers:
//  - game/skyguard/config/window_config.h
//  - game/skyguard/platform/user_paths.h
// Notes:
