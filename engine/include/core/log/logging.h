...
namespace core::log {
    ...
    namespace detail {
        ...
        /// Финальный обработчик паники — определяется вне retributio_core линкером.
        /// production : retributio_panic_sink_default -> MessageBox + std::exit.
        /// тесты      : retributio_core_test_support  -> throw PanicException.
