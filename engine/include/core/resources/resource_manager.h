...
namespace core::resources {
     ...
     *    AudioService, реализуемого в backend-модуле (retributio_sfml_audio). Game-код
    ...
    class ResourceManager {
      public:
        ...
        //  - Тесты передают стабы напрямую; глобального mutable state нет; RETRIBUTIO_TESTS нет.
        //
        // Важно:
