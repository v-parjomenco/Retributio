...
// Шум от компилятора по поводу инлайнинга/неинлайнинга функций
...
//  (временно закомментированно, но можно включить)
// ================================================================================================
...
// ================================================================================================
//  TODO(toolchain / CMake / Clang/GCC)
//  Этот файл сейчас настроен под MSVC + /Wall и вызывается через pch.h.
//  Когда будем переходить на CMake и несколько компиляторов, нужно:
//  - выделить ветки для других компиляторов (clang, gcc) и настроить для них диагностику;
//  - перенести часть политики ворнингов на уровень CMake/toolchain-файлов
//    (add_compile_options(), target_compile_options()) вместо .vcxproj;
//  - синхронизировать набор "глушимых" ворнингов между MSVC/Clang/GCC,
//    оставляя максимум сигналов для игрового кода;
//  - убедиться, что внешний код (SFML, системные заголовки) по-прежнему
//    отмечен как external и не засоряет лог /Wall-ворнингами.
// ================================================================================================
