// ================================================================================================
// File: tests/atrapacielos/src/background_math_test.cpp
// Purpose: Google Tests for background tiling math (computeTileStartY, computeTileCount).
// Used by: retributio_atrapacielos_tests (CTest, Debug config only)
// Related headers: presentation/background_math.h
// Notes:
//  - Migrated from background_math_self_test.cpp (RETRIBUTIO_TESTS static initializer pattern).
...
#include "presentation/background_math.h"

namespace {

    using game::atrapacielos::presentation::computeTileCount;
    using game::atrapacielos::presentation::computeTileStartY;
