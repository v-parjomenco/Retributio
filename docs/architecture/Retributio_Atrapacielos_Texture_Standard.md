# Atrapacielos Texture Standard v1.1 (corrected, no DDS, RRv1-compatible)

**Engine:** Retributio | **Library:** SFML 3.0.2  
**Engine Target:** Auctoritas (flagship, 100k+ registered textures; bounded active set via streaming/cache)  
**Current Product:** Atrapacielos (MVP, casual shooter for ages 6-13)

**Philosophy:** One engine, two profiles. Atrapacielos ships fast; engine decisions always stay compatible with Auctoritas scale.

---

## 1. PLATFORM & OPENGL BASELINE (Tiers)

### Tier0 — Atrapacielos (2026, broad reach)
- **OpenGL:** 3.3 minimum
...
### Tier1 — Auctoritas (2030+, forward-looking)
- **OpenGL:** 4.5 minimum
...
### Auctoritas Foundation (post-Atrapacielos)
...
- `atrapacielos.aircraft.su57`
- `auctoritas.unit.infantry.spearman`
- `auctoritas.city.roman.ancient`
...
- **Atrapacielos:** 0.8–1.2 typical, 1.5–2.0 only for hero/menu close-ups
...
### 6.2 Mipmaps
- Atrapacielos: generate once on load
- 4X: offline mipchain
...
- **Atrapacielos:** vibrant, high contrast, clean silhouettes, realistic aircraft reference look.
- **4X:** muted palette, historical atmosphere, readability-first (Port Royale 2 vibe).

AI prompts MUST specify profile (Atrapacielos vs 4X) explicitly.
...
- Atrapacielos: PNG workflow + sRGB + mipmaps + naming enforcement.
...
- BC pipeline scheduled post-Atrapacielos
